          ...
          var start = function(){
            ...
            for ( var i =0; i < 52; i++ ){
              ...
              for ( var j = 0; j < 7; j++ ){
                ...
                item_html += '<rect class="day" width="18" height="18" rx="5" y="'+ y +'" fill="'+ color + '" data-count="'+ count +'" data-date="'+ data_date +'"/>';
              }
            ...
            loop_html +=  '<text text-anchor="middle" class="wday" dx="-10" dy="22">{0}</text>'.formatString( settings.h_days[0] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="44">{0}</text>'.formatString( settings.h_days[1] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="66">{0}</text>'.formatString( settings.h_days[2] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="88">{0}</text>'.formatString( settings.h_days[3] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="110">{0}</text>'.formatString( settings.h_days[4] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="132">{0}</text>'.formatString( settings.h_days[5] )+
                          '<text text-anchor="middle" class="wday" dx="-10" dy="154">{0}</text>'.formatString( settings.h_days[6] );
            
            //Fixed size for now with width= 721 and height = 110
            var wire_html = 
              '<svg width="1221" height="310" viewBox="0 0 1321 310"  class="js-calendar-graph-svg">'+
